            ...
            if (currentDatacenter->isCdnDatacenter) {
                ...
                if (serverPublicKeys.empty()) {
                    if (ConnectionsManager::getInstance(currentDatacenter->instanceNum).testBackend) {
                        ...
                        serverPublicKeys.emplace_back("-----BEGIN RSA PUBLIC KEY-----\n"
                                                      "MIIBCgKCAQEAuCs2d6xDW01/fJmJLxe7iN6N5cDARt2xsxZO9/Iz53HaFZyqYCOr\n"
                                                      "35OLzf5iKMhA8O72qy8VNdUfoKak1LcNnP0bsIkwo3mHsvUAhmIwOTV/jrplytXy\n"
                                                      "XchpQs98fgI4THXre81C1OIbs4yL7KJca7pjOd6657EgMOAvZ8lgGbMPhMig3+rV\n"
                                                      "Q5pHJJLm9C4iq1u6fvPLL5sqc/s5SzQciXoT5D8RHBpIM7p6kS3cyLufLTPsassh\n"
                                                      "/LKv4bbQJiSXr57TS8D3FRnpdtG/O5PKUXPCBDyusTD1Qp3g1/950vfjVaKY+vo5\n"
                                                      "a1N4T5RC+/H/VdK6vqw9d+AseuSmFIWDJwIDAQAB\n"
                                                      "-----END RSA PUBLIC KEY-----");
                        serverPublicKeysFingerprints.push_back(0x97b5df763e13aeff);
                    }
                }
